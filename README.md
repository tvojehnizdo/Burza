...
### Futures audit reconstruction validation
Validates widened position-event history, completed-trade reconstruction across manager restarts, and explicit audit anomaly reporting.
