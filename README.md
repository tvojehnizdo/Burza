...
### Dynamic live futures hunter validation
The live canary now discovers tradeable PF_* perpetuals from Kraken instrument metadata, uses exchange tick/quantity precision, validates sendStatus, rescues existing positions, and keeps a one-position hard-cap lock.
