...
### Final live futures validation
Validates dynamic PF_* discovery, Kraken instrument-derived tick/quantity rules, accepted sendStatus handling, trigger+limit protective orders, rescue of existing positions, and the one-shot live launcher.
